...
follow these [instructions](https://github.com/CS50DartmouthSP25/home/blob/main/logistics/github.md), and then return here.

<!-- @CHANGEME change repository name in the clone statement below -->
6. Clone this repository into your home directory: 
	
	```bash
	git clone https://github.com/CS50DartmouthSP25/cs50-dev.git
	```
...
9. (OPTIONAL) To pick a preferred editor, edit `~/cs50-dev/dotfiles/profile.cs50` to uncomment one line defining `EDITOR`.
	...
	> Read [about editors](https://github.com/CS50DartmouthSP25/home/blob/main/logistics/systems.md#editors).
...
Much more information about the systems we use in CS50, including links to many other resources, can be found on the [systems page](https://github.com/CS50DartmouthSP25/home/blob/main/logistics/systems.md) of the course website.
